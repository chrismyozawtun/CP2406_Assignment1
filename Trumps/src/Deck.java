...
public class Deck {
    ...
    public Deck(){
        ...
        cards[5] = new MineralCard("The Miner", "Economic Value");
        ...
        cards[15] = new MineralCard("The Petrologist", "Crustal Abundance");
        ...
        cards[25] = new MineralCard("The Gemologist", "Hardness");
        ...
        cards[45] = new MineralCard("The Geophysicist", "Specific gravity or Magnetite");
        ...
        cards[55] = new MineralCard("The Geologist", "Any");
