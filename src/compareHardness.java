...
//select the first card position number
        ...
        double value = ((SupertrumpsCard) deck.cards[number]).getHardness(); //get hardness value of first card
        double value1 = ((SupertrumpsCard) deck.cards[number + 1]).getHardness(); //get hardness value of second card

//if value of hardness of first card equals second card
        if(value == value1){

            System.out.println((deck.cards[number]).getName() + " has the same value \"" +
                    ((SupertrumpsCard) deck.cards[number]).getHardness() + "\" of Hardness as " + (deck.cards[number + 1]).getName() +
                    " whose value is \"" + ((SupertrumpsCard) deck.cards[number + 1]).getHardness() + "\"");

//if value of hardness of first card > than second  card
        } else if (value > value1){

            System.out.println(deck.cards[number].getName() + " has a greater value \"" +
                    ((SupertrumpsCard) deck.cards[number]).getHardness() + "\" of Hardness than " + deck.cards[number + 1].getName() +
                    " whose value is \"" + ((SupertrumpsCard) deck.cards[number + 1]).getHardness() + "\"");
...
//if value of hardness of second card > than first card
            ...
            System.out.println((deck.cards[number + 1]).getName() + " has a greater value \"" +
                    ((SupertrumpsCard) deck.cards[number + 1]).getHardness() + "\" of Hardness than " + deck.cards[number].getName() +
                    " whose value is \"" + ((SupertrumpsCard) deck.cards[number]).getHardness() + "\"");
        }
    }
