 ...
 */
public class compareCrustalAbundance {
    static Deck deck;
    ...
    public static void main(String[] args) { //create deck of cards, randomly select 2 adjacent cards and compare their crustal abundance locations in the array
        ...
        String [] crustalAbundanceHierarchy = {"ultratrace", "trace", "low", "moderate", "high", "very high"}; //make crustal abundance array - low to high
            ...
            int index1 = Arrays.asList(crustalAbundanceHierarchy).indexOf(((SupertrumpsCard) deck.cards[number]).getCrustalAbundance()); //get index number of 1st card in array
            int index2 = Arrays.asList(crustalAbundanceHierarchy).indexOf(((SupertrumpsCard) deck.cards[number + 1]).getCrustalAbundance()); //get index number of 2nd card in array
            ...
            if (index1 == index2){ // if locations of value in crustal abundance array are equal
                ...
                System.out.println((deck.cards[number]).getName() + " has the same value \"" +
                        ((SupertrumpsCard) deck.cards[number]).getCrustalAbundance() + "\" of Crustal Abundance as " + (deck.cards[number + 1]).getName() +
                        " whose value is \"" + ((SupertrumpsCard) deck.cards[number + 1]).getCrustalAbundance() + "\"");
                ...
                System.out.println(deck.cards[number].getName() + " has a greater value \"" +
                        ((SupertrumpsCard) deck.cards[number]).getCrustalAbundance() + "\" of Crustal Abundance than " + deck.cards[number + 1].getName() +
                        " whose value is \"" + ((SupertrumpsCard) deck.cards[number + 1]).getCrustalAbundance() + "\"");
                ...
                System.out.println((deck.cards[number + 1]).getName() + " has a greater value \"" +
                        ((SupertrumpsCard) deck.cards[number + 1]).getCrustalAbundance() + "\" of Crustal Abundance than " + deck.cards[number].getName() +
                        " whose value is \"" + ((SupertrumpsCard) deck.cards[number]).getCrustalAbundance() + "\"");
            }
        }
